...
- [ ] add a #stack tag, that makes a column not be moved on a new line, but stay below the column previous to it. it can be saved to the markdown. also add a column option to toggle the #stack tag on and off for a column.
